...
public partial class EditReimbursment : BasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        string ReimbursmentID = " ";
        if (Request.QueryString["ReimbursmentID"] != null)
        {
            ReimbursmentID = Request.QueryString["ReimbursmentID"];
        }

        if (!IsPostBack)
        {
            bindCombos();
            if (!string.IsNullOrEmpty(Request.QueryString["ReimbursmentID"]))
            {
                bindRecord();
                bindAttach();
            }
    ...
    protected void bindAttach()
    {
        try
        {
            ...
            ht_attach.Add("@ID", Request.QueryString["ReimbursmentID"]);
    ...
    private void ShowReadOnlyPage(ControlCollection objCtrl)
    {
        try
        {
            ...
            {
                this.Title = "Edit Reimbursement Details";
