    ...
    <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" ClientEvents-OnRequestStart="onRequestStart" LoadingPanelID="RadAjaxLoadingPanel1">
        <div class="widget">
            ...
            <table style="margin-top:25px;">
                ...
                <tr>
                    <td style="padding-bottom: 15px;padding-right: 18px;">
                        <asp:Label ID="lblcopyNvalue" CssClass="ConfigLabel" runat="server" Text="Copy N Value:"></asp:Label>
                        <asp:TextBox TextMode="Number" ID="txtcopyNvalue" style="width:200px;" Text="0" runat="server" ClientIDMode="Static" ></asp:TextBox>
                       
                    </td>
                    <td>
                         <asp:RequiredFieldValidator ID="rfvtxtcopyNvalue" Style="float: left" runat="server" ErrorMessage="*" 
                            ForeColor="Red" Display="Dynamic" ControlToValidate="txtcopyNvalue" ValidationGroup="FrmSubmit"></asp:RequiredFieldValidator>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td style="padding-bottom: 15px;">
                        <asp:Label ID="lblishrtprthisreq" CssClass="ConfigLabel" runat="server" Text="Is Hour type Premium history required:"></asp:Label>
                        <telerik:RadCheckBox ID="cbxishrtprthisreq" runat="server" ></telerik:RadCheckBox>
                    </td>
                </tr>

                <tr>
                    <td style="padding-bottom: 15px;">
                        <asp:Label ID="lblisfrioff" CssClass="ConfigLabel" runat="server" Text="Is Friday Off:"></asp:Label>
                        <telerik:RadCheckBox ID="cbxisfrioff" runat="server" ></telerik:RadCheckBox>
                    </td>
                </tr>
                <tr>
                    <td style="padding-bottom: 15px;">
                        <asp:Label ID="lblissatoff" CssClass="ConfigLabel" runat="server" Text="Is Saturday Off:"></asp:Label>
                        <telerik:RadCheckBox ID="cbxissatoff" runat="server" ></telerik:RadCheckBox>
                    </td>
                </tr>
                <tr>
                    <td style="padding-bottom: 15px;">
                        <asp:Label ID="lblissunoff" CssClass="ConfigLabel" runat="server" Text="Is Sunday Off:"></asp:Label>
                        <telerik:RadCheckBox ID="cbxissunoff" runat="server" ></telerik:RadCheckBox>
                    </td>
                </tr>
                <tr>
                    <td>
