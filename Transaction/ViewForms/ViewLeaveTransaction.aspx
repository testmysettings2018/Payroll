<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Main.master" AutoEventWireup="true" CodeFile="ViewLeaveTransaction.aspx.cs" Inherits="Payroll_Transaction_ViewForms_ViewLeaveTransaction" %>
                            ...
                            <div class="widget">
                                ...
                                <div class="formRow">
                                    <div class="formCol">
                                        ...
                                        <div class="formRight">
                                            <telerik:RadComboBox ID="rCmbEntryType" runat="server" Width="400px" DropDownWidth="400px" EmptyMessage="Please select...">
                                                <ItemTemplate>
                                            ...
                                            <telerik:RadComboBox ID="rCmbLeaveType" runat="server" Width="400px" DropDownWidth="400px" EmptyMessage="Please select...">
                                                <ItemTemplate>
                                                    <telerik:RadGrid ID="rGrdLeaveTypes4DDL" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                                                        CellSpacing="0" GridLines="None" Width="400px" ClientSettings-EnableRowHoverStyle="True" OnItemCommand="rGrdLeaveTypes4DDL_ItemCommand">
                                ...
                                <div class="formRow">
                                    <div class="formCol">
                                        ...
                                        <div class="formRight">
                                            <telerik:RadDatePicker ID="txtFromDate" runat="server" DateInput-DateFormat="MM/dd/yyyy"></telerik:RadDatePicker>
                                        </div>
                                    </div>
                                    <div class="clear"></div>
                                </div>
                                <div class="formRow">
                                    <div class="formCol">
                                        <label>To Date</label>
                                        <div class="formRight">
                                            <telerik:RadDatePicker ID="txtToDate" runat="server" DateInput-DateFormat="MM/dd/yyyy"></telerik:RadDatePicker>
                                        </div>
                                    </div>
                                ...
                                <div class="formRow">
                                    <div class="formCol">
                                        ...
                                        <div class="formRight">
                                            <asp:CheckBox Enabled="false" ID="checkAirTicket" runat="server" Text=""></asp:CheckBox>
                                        </div>
                                    </div>
                                ...
                                <div class="formRow">
                                    <div class="formCol">
                                        ...
                                        <div class="formRight">
                                            <telerik:RadAsyncUpload Enabled="false" runat="server" ID="ruDocument" overwriteexistingfiles="true"
                                        ...
                                        <ItemTemplate>
                                               ...
                                               <li>
                                                <dl>
                                                    ...
                                                    <asp:ImageButton ID="delAttch" Enabled="false" runat="server" CommandName="Remove" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "idd").ToString() %>' Text="Delete Attachment"
                                                    ...
                                                    <dt>File Description:
                                                       <telerik:RadTextBox ID="txtfiledescription" runat="server" Height="200px" Text='<%# DataBinder.Eval(Container.DataItem, "description").ToString() %>' TextMode="MultiLine" Columns="200" Rows="3"></telerik:RadTextBox>
                                                                            <asp:ImageButton ID="upAttach" Enabled="false" runat="server" CommandName="Change" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "idd").ToString() %>' Text="Update"
