<%@ Page Title="Project Employee Assignment" Language="C#" MasterPageFile="~/MasterPages/UserMasterPage.master" AutoEventWireup="true" CodeFile="ProjectEmployeeAssignment.aspx.cs" Inherits="ProjectEmployeeAssignment" %>
    ...
    <style>
     ...
     <telerik:RadCodeBlock ID="rcb1" runat="server">
        <script type="text/javascript">
            ...
            function ValidateProjectMaster(ddlEmployeeId) {
                var str = '';
        ...
        <fieldset>
            <div class="widget">
                <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" ClientEvents-OnRequestStart="onRequestStart" LoadingPanelID="RadAjaxLoadingPanel1">
                    <div class="formRight">
                        <telerik:RadGrid ID="gvProject" runat="server" AllowPaging="True" AllowSorting="True" AllowFilteringByColumn="false"
                            AutoGenerateColumns="False" CellSpacing="0" GridLines="None" OnInsertCommand="gvProject_InsertCommand"
                            OnNeedDataSource="gvProject_NeedDataSource" PageSize="20" OnDeleteCommand="gvProject_DeleteCommand"
                            OnUpdateCommand="gvProject_UpdateCommand" ShowStatusBar="false" OnItemDataBound="gvProject_ItemDataBound"
                            OnItemCommand="gvProject_ItemCommand" OnDetailTableDataBind="gvProject_DetailTableDataBind"
                            OnItemCreated="gvProject_ItemCreated" >
                            ...
                            <MasterTableView CommandItemDisplay="Top" AutoGenerateColumns="False" DataKeyNames="prjidd,prjcod" 
                                InsertItemPageIndexAction="ShowItemOnCurrentPage" EditMode="EditForms">
                                <DetailTables>
                                    <telerik:GridTableView runat="server" Name="ProjectDetail" CommandItemDisplay="Top" EditMode="EditForms" DataKeyNames="recidd"  AllowFilteringByColumn="false">
                                        <CommandItemTemplate>
                                            <div class="title">
                                        ...
                                        <Columns>
                                            ...
                                            <telerik:GridButtonColumn ButtonType="ImageButton" CommandName="Delete" ConfirmText="Are you sure to delete this record?"
                                                ...
                                                UniqueName="DeleteProjectDetail" ConfirmTextFormatString='Are you sure to delete project employee assignment record # {0}?'>
                                ...
                                <CommandItemTemplate>
                                    <div class="title">
                                        <img src="../../images/icons/dark/list.png" alt="" class="titleIcon" /><h6>Projects List</h6>
                                    </div>
                                    <tr class="rgCommandRow">
                                ...
                                <Columns>
                                    <telerik:GridBoundColumn DataField="prjidd" SortExpression="prjidd" FilterControlAltText="Filter prjidd column"
                                    ...
                                    <telerik:GridTemplateColumn DataField="prjcod" FilterControlWidth="130px" SortExpression="prjcod" AutoPostBackOnFilter="true" CurrentFilterFunction="Contains" FilterControlAltText="Filter prjcod column"
                                            ...
                                            <table>
                                                <tr>
                                                    <td style="width: 250px; border-bottom: 0px; padding-left: 0px">
                                                        <asp:Label ID="lblprjcod1" runat="server" Text='<%# Eval("prjcod") %>'></asp:Label>
                                                    </td>                                           
                                                </tr>
                                            </table>
                                        </EditItemTemplate>
                                    ...
                                    <telerik:GridEditCommandColumn FilterControlAltText="Filter EditCommandColumn column" UniqueName="EditProject"
                                    ...
                                    <telerik:GridButtonColumn ButtonType="ImageButton" CommandName="Delete" ConfirmText="Are you sure to delete this Project record?"
                                        ConfirmTextFields="prjidd" ConfirmTitle="Delete" FilterControlAltText="Filter column6 column"
                                        ItemStyle-Width="0px" UniqueName="DeleteProject" ConfirmTextFormatString='Are you sure to delete the detail of project record # "{0}"?'>
                                        <ItemStyle HorizontalAlign="Center" />
                                    </telerik:GridButtonColumn>
                                </Columns>
                                <EditFormSettings CaptionFormatString='Edit Project record # "{0}":' CaptionDataField="prjidd">
                                    <EditColumn FilterControlAltText="Filter EditCommandColumn column">
                                    </EditColumn>
